            ...
            <nav className="hidden md:flex gap-6 text-sm font-medium text-slate-600">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-64 p-2" align="start">
                  <DropdownMenuLabel className="text-xs text-gray-500 font-normal mb-1">웹 개발 과정</DropdownMenuLabel>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-blue-100 text-blue-600 rounded-full shrink-0"><Globe className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-purple-100 text-purple-600 rounded-full shrink-0"><Code className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-orange-100 text-orange-600 rounded-full shrink-0"><Server className="w-5 h-5" /></div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-64 p-2" align="start">
                  <DropdownMenuLabel className="text-xs text-gray-500 font-normal mb-1">인프라 및 혁신 과정</DropdownMenuLabel>

                  <Link href="/community/4">
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-indigo-100 text-indigo-600 rounded-full shrink-0"><Bot className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-slate-200 text-slate-700 rounded-full shrink-0"><ShieldCheck className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-orange-100 text-orange-600 rounded-full shrink-0"><Cloud className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-lime-100 text-lime-600 rounded-full shrink-0"><Box className="w-5 h-5" /></div>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-64 p-2" align="start">
                  ...
                  <DropdownMenuLabel className="text-xs text-gray-500 font-normal mb-1">기획 및 디자인 과정</DropdownMenuLabel>

                  <Link href="/community/8">
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-pink-100 text-pink-600 rounded-full shrink-0"><Palette className="w-5 h-5" /></div>
                  ...
                  <DropdownMenuItem className="cursor-pointer p-2 flex items-center gap-3 focus:bg-slate-50 focus:text-slate-900 rounded-md">
                    <div className="p-2 bg-green-100 text-green-600 rounded-full shrink-0"><Lightbulb className="w-5 h-5" /></div>
